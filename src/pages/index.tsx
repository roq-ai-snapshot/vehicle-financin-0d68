  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the pinnacle of vehicle financing with Vehicle Financing Application - your ultimate solution for seamless, reliable and efficient car financing."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1541348263662-e068662d82af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2ZWhpY2xlfGVufDB8fHx8MTY5ODg1MDQwMnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the pinnacle of vehicle financing with Vehicle Financing Application - your ultimate solution for seamless, reliable and efficient car financing.`}
            </Text>
            <Box
